                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="btn-group btn-block">
                                                    <asp:Button ID="Button2" class="btn btn-info-blue mr-1" runat="server" Text="Home" OnClick="Button2_Click" autopostback="false" />
                                                    <asp:Button ID="Button3" class="btn btn-info-blue" runat="server" Text="Clear" OnClick="Button3_Click" autopostback="false" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
